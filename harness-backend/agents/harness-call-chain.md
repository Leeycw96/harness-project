...
读取 `HARNESS_PROFILE`、profile、`state.json`、本文件、项目手册、plan、build-scope、已有 `.harness/call-chain/` 和 Builder commit diff。source `.codex/common/scripts/harness-common.sh` 并写 progress：
