  ...
  jq -n \
    ...
    '{
      ...
      agents: {
        ...
        "harness-qa": {
          agent_doc: ".claude/agents/harness-qa.md"
        },
        "harness-code-review": {
          agent_doc: ".claude/agents/harness-code-review.md"
        },
        "harness-call-chain": {
          agent_doc: ".claude/agents/harness-call-chain.md"
        },
        "harness-feedback-triage": {
          agent_doc: ".claude/agents/harness-feedback-triage.md"
        }
      },
      thresholds: {
      ...
      lifecycle: {
        ...
        stop_agent_after_stage: true,
        stop_parallel_agent_when_done: true,
        stop_stalled_agent_before_replacement: true
      },
      limits: {
        scope_attempts: 3,
        fix_rounds: 3,
