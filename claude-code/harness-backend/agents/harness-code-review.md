...
读取 `HARNESS_PROFILE`、profile、`state.json`、本文件、项目 review guidance 和 `.claude/common/refs/harness-backend-coding-rules.md`。source `.claude/common/scripts/harness-common.sh` 并写 progress。
