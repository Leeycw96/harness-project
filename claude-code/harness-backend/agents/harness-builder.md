...
description: "Harness Builder for SCOPE_BUILD, BUILD, BUILD_FAST, FIX, and FIX_FAST."
...
3. 读取 `.claude/common/refs/harness-backend-coding-rules.md`。
4. source `.claude/common/scripts/harness-common.sh`，执行：
